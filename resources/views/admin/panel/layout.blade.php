...
<body>
    ...
    <div id="menu" class="fixed h-full bg-gray-900 md:w-52 w-40 transition-all duration-300 ease-in-out">
        <ul class="py-52">
            ...
            <li class="p-1 mb-1 flex hover:bg-green-700 {{ Route::is('admin.dashboard.users') ? 'bg-green-700' : ''}}">
                <a href="{{ route('admin.dashboard.users') }}" class="text-white font-semibold text-xl w-full h-full flex items-center justify-center p-1 m-2 hover:border-l-4 border-l-lime-400">Users</a>
            </li>
            <li class="p-1 mb-1 flex hover:bg-green-700">
